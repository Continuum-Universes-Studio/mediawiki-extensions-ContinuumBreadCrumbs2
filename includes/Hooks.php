...
use MediaWiki\Storage\Hook\PageSaveCompleteHook as StoragePageSaveCompleteHook;
use MediaWiki\Title\Title;
use MediaWiki\User\UserIdentity;

class Hooks implements SkinSubPageSubtitleHook, SidebarBeforeOutputHook, StoragePageSaveCompleteHook {
	...
	public static function onRegistration(): void {
		...
		$base = rtrim( $scriptPath, '/' ) . '/extensions/ContinuumBreadCrumbs2/resources/assets';
